...
<?php
    ...
    $reponse = $bdd->query('SELECT * FROM surf WHERE 1');//requête de de recupération des éléments présent dans la table surf de la bdd pour chaque ligne
    while ($row = $reponse->fetch(PDO::FETCH_OBJ)) { //boucle while qui à pour effet de recuperer les infos de la table correspondantes autants de fois qu'il y a de lignes.
      $image = $row->image;
    echo '<div>
    <table>
    <tr>
    ...
    <a href="#" id="ajoutFavorieSurf">Ajouter<a>
    <br/><br/>
    </td>
    </tr>
    </table>
...
<script src="jQuery.js"></script><!--Lien ver le fichier de la bibliotheque jQuery-->
<script src="main.js" ></script><!--Lien ver le fichier js-->
</body>
</html>